...
const LandingPage = () => {
    ...
    useEffect(() => {
      ...
      const handleSelectChampion = useCallback((i) =>{
        console.log(realChampion[i].image.full)
      ...
      console.log("선택된이미지들",SelecedChampions)
    ...
    return (
        ...
        <CircleImage/>
          ...
          <div style={{display:"flex",flexDirection:"column" ,position:"absolute" ,top:30,left:0 }}>
          {SelecedChampions && SelecedChampions.map(SelecedChampion => <Image
